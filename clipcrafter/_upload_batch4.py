"""Upload batch 4 (9 new clips)"""
import sys, os, json
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from youtube_uploader import upload_video

out_dir = os.path.expanduser("~/clipcrafter_downloads/clipes/processados")
os.environ["OAUTH_PATH"] = os.path.expanduser("~/client_secret.json")
meta = json.load(open(os.path.join(out_dir, "clips_metadata4.json")))
